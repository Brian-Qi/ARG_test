  ...
  <Teleport to="body">
    <div class="am-mask" @click.self="close">
      <div class="am-panel">
        ...
        <p class="am-legend">
          <span class="am-dot solid"></span>已探明 <span class="am-dot open"></span>可达未读 <span class="am-dot void"></span>未解锁
        </p>
...
.am-tree {
  ...
  border-left: 1px solid rgba(150, 122, 85, 0.2);
}
.am-node {
  position: relative;
  display: flex;
...
.am-node::before {
  ...
  width: 0.75rem;
  height: 1px;
  background: rgba(150, 122, 85, 0.28);
}
.am-mark {
  width: 7px;
  height: 7px;
...
.am-node.solid .am-mark {
  background: #c9a25a;
  box-shadow: 0 0 8px rgba(201, 162, 90, 0.5);
}
.am-node.open .am-mark {
  background: transparent;
  border: 1px solid #9a7b52;
}
.am-node.void .am-mark {
  background: transparent;
...
.am-node.open .am-title {
  color: #b99a6a;
}
.am-node.void .am-title {
  color: #6a5942;
  letter-spacing: 0.2em;
}
.am-link:hover .am-title {
  color: #d13424;
}
.am-tag {
  font-size: 0.72rem;
