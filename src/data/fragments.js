...
const FRAGMENTS = [
  ...
  },
  {
    ...
    content: [
      ...
      '招贴上的广告语底下，压着五尊神的名号：比干、柴荣、关公、赵公明、王亥。名号与通行谱系不合，方位亦被人剪去，只剩五个空位。',
      '哪一尊守哪一方，招贴上没写。散在旧档里的几笔底账，才各记着一位的去处，得自己去拼。',
      '认出他们，再按各自的典故，反推出各自守着哪一槛。五槛非路，是门、柜、梁、井、窗。',
      '五神的德目与去处，另见底档《算盘珠号码》《红袄衣角》《财神化疏仪式》《点灯迎财旧俗》《无芯灯》。'
    ],
  ...
  },
  {
    ...
    tag: '影像修复',
    img: '/img/baishi.webp',
    summary: '三张馆藏影像，年代不同，脸上却都留着一道被刮开的旧裂。',
    content: [
      '馆藏影像三张，来源各异，同批修复。',
      '其一，1901，一尊披甲的财神石像；其二，1916，一尊宽袍的文士石像；其三，修复系统显示“今夜”入档，是一座无名石龛，龛中面容模糊不可辨。',
      '三张脸都被刻过：不是磕碰的裂，是有人拿一件东西，顺着脸把名字刮了下去。',
      '修复员注：三张的裂口都起于面部、深浅相仿，疑出自同一件器物、同一手法。',
