  ...
  <div class="search-page" :class="{ landing: !q }">
    ...
    <template v-if="q && results.length">
      <h2 class="section-title">
        检索结果 <small>共 {{ results.length }} 条</small>
      </h2>
      ...
      <div v-for="(r, i) in results" :key="i" class="archive-panel search-result-panel">
        <div class="search-result-header">
          <h2 class="search-result-title">
            <RouterLink v-if="r.to" :to="r.to">{{ r.title }}</RouterLink
...
const ALL = [
  {
    to: '/collection/HZ-1927-0512',
    title: '万和号商号流水账',
    type: '档案 · 全文公开',
    id: '馆藏号 HZ-1927-0512',
    desc: '民国十六年至二十一年，杭州城南绸布南北货商号。日记流水体，毛笔书写，共 86 页，含每月小计与年终汇算。',
    kw: ['万和号', '账簿', '流水账', '商号', '账'],
    snippet: true
  },
  // —— 数字化专题：档案资源整理（民俗学视角，无具体地域） ——
  {
    ...
    type: '文献辑录',
    id: '专题 CW-0001',
    desc: '辑录各地财神信俗相关的经册、祝文、杂记与口述史料，依主题编次以供检索。',
    kw: ['信俗', '文献', '辑录', '财神']
  },
  {
    title: '财神年画图档整理',
    type: '图档整理',
    id: '专题 CW-0002',
    desc: '对旧历年画中的财神题材图档进行分类著录，附元宝、聚宝盆、如意等吉祥符号考。',
    kw: ['年画', '图档', '财神']
  },
  {
    title: '民间商号文书著录',
    type: '文书著录',
    id: '专题 CW-0003',
    desc: '著录民间商号的经营账簿、契约与票单据，为商俗与经济史研究提供原始材料。',
    kw: ['商号', '文书', '著录', '账簿']
  },
  {
    title: '财神祭祀祝文辑录',
    type: '祝文辑录',
    id: '专题 CW-0004',
    desc: '收录岁首迎财、商铺开市等场合所用的祭祀祝文与祈财疏文，可窥民间仪式语汇。',
    kw: ['祝文', '祭祀', '疏文']
  },
  {
    title: '民俗碑记拓片整理',
    type: '拓片整理',
    id: '专题 CW-0005',
    desc: '整理记录地方慈善、行会与祭祀碑文的拓片，兼及碑刻书风与款识的著录说明。',
    kw: ['拓片', '碑记', '碑刻', '慈善']
  },
  {
    title: '民间求财旧俗考释',
    type: '旧俗考释',
    id: '专题 CW-0006',
    desc: '考释开市点灯、破五迎财、供三牲等民间求财旧俗的仪式做法与背后寓意。',
    kw: ['求财', '旧俗', '考释', '破五']
  },
  {
    title: '财神谱系田野调查',
    type: '田野调查',
    id: '专题 CW-0007',
    desc: '通过田野访谈梳理民间财神谱系的区域性差异，兼及仪式性拜财行为的当代形态。',
    kw: ['谱系', '田野', '调查', '财神']
  },
  // —— 近期上线：知识研究成果 ——
  {
    ...
    type: '民俗考源',
    id: '专题 CW-0008',
    desc: '梳理"五路财神"由五方之神到财神谱系的演化脉络，兼及"路路通财"的心理祈愿。',
    kw: ['五路', '财神', '来源', '流变']
  },
  {
    title: '赵公明：从瘟神到财神的演变',
    type: '信仰演变',
    id: '专题 CW-0009',
    desc: '考述赵公明自汉魏厉鬼、魏晋瘟神，至明清定型为"金龙如意正一龙虎玄坛真君"财神的演变。',
    kw: ['赵公明', '瘟神', '玄坛', '演变']
  },
  {
    title: '武财神关羽的忠义财道',
    type: '人物考源',
    id: '专题 CW-0010',
    desc: '关羽因"挂印封金""一介不取"的忠信义举，被商贾奉为以信义立业之武财神。',
    kw: ['关羽', '武财神', '忠义', '诚信']
  },
  {
    title: '文财神比干的无私之德',
    type: '人物考源',
    id: '专题 CW-0011',
    desc: '比干因无心而无偏私，被奉为公正无私的文财神，体现"无私方能聚财"的民间财富伦理。',
    kw: ['比干', '文财神', '无私', '公正']
  },
  {
    title: '小五路财神与招宝纳珍考辨',
    type: '谱系考辨',
    id: '专题 CW-0012',
    desc: '考辨赵公明麾下招宝天尊、纳珍天尊、招财使者、利市仙官"小五路"的构成与职司。',
    kw: ['小五路', '招宝', '纳珍', '利市']
  },
  {
    title: '「君子爱财，取之有道」考释',
    type: '思想考释',
    id: '专题 CW-0013',
    desc: '由《论语》富与贵之辩出发，考释"取之有道""为富且仁"在民间财神信俗中的渗透。',
    kw: ['取之有道', '君子爱财', '为富且仁', '义利']
  },
  {
    title: '「以德聚财，以财济世」理念溯源',
    type: '思想考释',
    id: '专题 CW-0014',
    desc: '探讨财神信俗精髓"以德聚财、以财济世"，如何体现民间光明磊落的财富观。',
    kw: ['以德聚财', '济世', '财富观']
  },
  // —— 隐匿族谱：解锁后才会出现 ——
  {
    to: '/archives/SP-1927-0007',
    title: '沈晚族谱',
    type: '家谱档案',
    id: '馆藏号 SP-1927-0007',
    hidden: true,
    desc: '万和号店主沈氏一族家谱。谱末一栏记其后人：女，沈晚。父，沈砚秋。',
    kw: ['沈晚', '族谱', '沈砚秋', '家谱']
  }
]
